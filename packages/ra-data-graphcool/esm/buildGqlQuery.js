...
export var buildFields = function (introspectionResults) { return function (fields) {
    return fields.reduce(function (acc, field) {
        ...
        if (linkedType) {
            return __spreadArrays(acc, [
                gqlTypes.field(gqlTypes.name(field.name), null, null, null, gqlTypes.selectionSet(__spreadArrays(buildFragments(introspectionResults)(linkedType.possibleTypes || []), buildFields(introspectionResults)(linkedType.fields)))),
            ]);
        }
