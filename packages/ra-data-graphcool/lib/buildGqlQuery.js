...
exports.buildFields = function (introspectionResults) { return function (fields) {
    return fields.reduce(function (acc, field) {
        ...
        if (linkedType) {
            return __spreadArrays(acc, [
                gqlTypes.field(gqlTypes.name(field.name), null, null, null, gqlTypes.selectionSet(__spreadArrays(exports.buildFragments(introspectionResults)(linkedType.possibleTypes || []), exports.buildFields(introspectionResults)(linkedType.fields)))),
            ]);
        }
